...
export function Topbar({
  ...
  return (
    <header className="flex h-16 items-center justify-between gap-3 border-b border-forge-800 bg-forge-950/80 px-4 backdrop-blur-xl sm:px-6">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <button
          onClick={onMenuClick}
          className="grid h-9 w-9 shrink-0 place-items-center rounded-lg text-forge-400 hover:bg-forge-800 hover:text-forge-100 md:hidden"
          aria-label="Open menu"
        >
          <Menu className="h-5 w-5" />
        </button>

        <button className="hidden w-72 items-center gap-2 rounded-lg border border-forge-700 bg-forge-900 px-3 py-2 text-sm text-forge-500 transition hover:border-forge-600 sm:flex">
        ...
        <button
          className="grid h-9 w-9 shrink-0 place-items-center rounded-lg text-forge-400 hover:bg-forge-800 hover:text-forge-100 sm:hidden"
